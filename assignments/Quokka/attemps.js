...
// Jonathans Answer
//Imperative
// for(const car of inventory) carModels.push(car.car_model);
// carModels.sort();

// console.log(carModels);

//Declaritive
carModels = inventory.map(car => car.car_model).sort();
...
//Imperative
for(const car of inventory) carYears.push(car.car_year);
...
let makeFilter = ['BMW', 'Audi'];

BMWAndAudi = inventory.filter(car => makeFilter.includes(car.car_make));
...
//Imperative
// const validMakes = ['BMW', 'Audi'];

// for(const car of inventory) {
// 	if(validMakes.includes(car.car_make)){
// 		BMWAndAudi.push(car);
// 	}
// }
...
//Declarative 
// BMWAndAudi = inventory.filter(car => validMakes.includes(car.car_make));
